...
export default function PhilosophySection() {
    return (
        <section
            className="relative w-full h-full bg-[#050505] text-[#f4f4f0] py-4 md:py-16 px-6 md:px-12 lg:px-20 overflow-hidden flex flex-col items-center justify-center"
        ...
        >
            ...
            <div className="w-full max-w-[90rem] mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between gap-12 md:gap-8 lg:gap-16 px-4 md:px-12">
                ...
                <motion.div
                    ...
                    className="hidden md:block w-[85%] md:w-[28%] aspect-[3/4] relative order-2 md:order-1"
                >
                ...
                <motion.div
                    ...
                    className="w-full md:w-[40%] flex flex-col items-center order-1 md:order-2"
                >
                    <div className="w-[60%] md:w-full aspect-[4/5] relative mb-6 md:mb-10 overflow-hidden shadow-2xl">
                        <SlideshowImage imagesArr={images.center} intervalOffset={1000} />
                    </div>

                    <motion.div variants={textFadeUp} className="relative w-full px-6">
                        <span className="absolute -top-8 -left-2 text-[6rem] leading-none text-[#bba371]/20 font-serif">"</span>
                        <p className="text-center text-lg md:text-2xl italic leading-relaxed tracking-wide opacity-90">
                ...
                <motion.div
                    ...
                    className="hidden md:block w-[85%] md:w-[28%] aspect-[3/4] relative order-3 mt-4 md:mt-12"
                >
